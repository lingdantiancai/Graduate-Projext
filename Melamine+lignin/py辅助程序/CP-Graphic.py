...
path = 'C:/Users/lingd/Google Drive/毕业设计/毕业设计/实验数据/Graduate-Projext/Melamine+lignin/20180413/900-碱性/CP'
...
def findpoint(y):#另外一种寻找中值最小点的方式
	...
	sign = False
	for a in range(i):
		v = y[i-a-1]-y[i-a-5]#减去当前位置之前值，来判断增减性。其中8的设置是为了避免近距离数值之间的波动造成误差
